# __author__=xk
# -*- coding: utf-8 -*-
from baseEntity.userEntity import AbstractUserEntity
class UserEntity:
    ...
    def getValue(self):
        return (self.username, self.realname, self.location, self.photosurl, self.profileurl, self.photocount,
                self.firstdatetaken, self.uid)
